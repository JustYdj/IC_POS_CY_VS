...
/**
  ...
  */
#define MFRC522_SPI_CS_PIN                           GPIO_PIN_7        /* PB.02*/
#define MFRC522_SPI_CS_GPIO_PORT                     GPIOD
#define MFRC522_SPI_CS_GPIO_CLK_ENABLE()             __HAL_RCC_GPIOD_CLK_ENABLE()
#define MFRC522_SPI_CS_GPIO_CLK_DISABLE()            __HAL_RCC_GPIOD_CLK_DISABLE()

#define MFRC522_RST_PIN                           GPIO_PIN_9        /* PB.02*/
#define MFRC522_RST_GPIO_PORT                     GPIOB
#define MFRC522_RST_GPIO_CLK_ENABLE()             __HAL_RCC_GPIOB_CLK_ENABLE()
#define MFRC522_RST_GPIO_CLK_DISABLE()            __HAL_RCC_GPIOB_CLK_DISABLE()
/**
  * @brief  M25P FLASH SPI Chip Select macro definition 
  */
#define MFRC522_SPI_CS_LOW()       HAL_GPIO_WritePin(MFRC522_SPI_CS_GPIO_PORT, MFRC522_SPI_CS_PIN, GPIO_PIN_RESET)
#define MFRC522_SPI_CS_HIGH()      HAL_GPIO_WritePin(MFRC522_SPI_CS_GPIO_PORT, MFRC522_SPI_CS_PIN, GPIO_PIN_SET)

#define MFRC522_RST_LOW()       HAL_GPIO_WritePin(MFRC522_RST_GPIO_PORT, MFRC522_RST_PIN, GPIO_PIN_RESET)
#define MFRC522_RST_HIGH()      HAL_GPIO_WritePin(MFRC522_RST_GPIO_PORT, MFRC522_RST_PIN, GPIO_PIN_SET)
